...
public class Configs {
	...
	public static final String THONG_TIN_BAI_XE_PATH  = "/views/fxml/thongTinBaiXe.fxml";
	public static final String THUE_XE_CHON_THE_PATH  = "/views/fxml/chonTheThanhToan.fxml";
	public static final String THUE_XE_XAC_NHAN_PATH  = "/views/fxml/xacNhanThanhToan.fxml";
